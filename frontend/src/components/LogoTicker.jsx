...
export default function LogoTicker({ title, items }) {
  ...
  return (
    <div className="py-10 bg-white dark:bg-[#000000] overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 w-16 md:w-32 h-full bg-gradient-to-r from-white to-transparent dark:from-[#000000] z-10 pointer-events-none" />
        <div className="absolute top-0 right-0 w-16 md:w-32 h-full bg-gradient-to-l from-white to-transparent dark:from-[#000000] z-10 pointer-events-none" />
              ...
              >
                {item.logo_url ? (
                  <img 
                    src={item.logo_url} 
                    alt={item.name} 
                    className="h-10 md:h-12 object-contain mix-blend-multiply dark:mix-blend-screen" 
