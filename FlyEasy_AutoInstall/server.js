...
// Auto-installer for Hostinger zero-click deploy
if (process.env.DB_HOST) {
  (async () => {
    try {
      ...
      if (rows.length === 0) {
        console.log("Database looks empty. Auto-importing SQL dump...");
        const fs = require('fs');
        ...
        if (fs.existsSync(dumpPath)) {
          ...
          try {
            ...
            console.log("Deleted flyeasy_full_dump.sql automatically.");
          } catch(e) {}
        }
      }
    } catch (err) {
